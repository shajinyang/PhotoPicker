...
import com.sjy.pickphotos.pickphotos.crop.cropwindow.edge.Edge;
import com.sjy.pickphotos.pickphotos.crop.cropwindow.handle.Handle;
import com.sjy.pickphotos.pickphotos.crop.util.AspectRatioUtil;
import com.sjy.pickphotos.pickphotos.crop.util.DisplayUtil;
import com.sjy.pickphotos.pickphotos.crop.util.HandleUtil;
import com.sjy.pickphotos.pickphotos.crop.util.PaintUtil;
...
public class CropImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        mHandleRadius = DisplayUtil.dip2px(context,24);
        mSnapRadius = DisplayUtil.dip2px(context,3);
        mBorderThickness = DisplayUtil.dip2px(context,3);
        mCornerThickness = DisplayUtil.dip2px(context,5);
        mCornerLength = DisplayUtil.dip2px(context,20);
    }
